...
> = {
  en: {
    ...
    updatingFromCache: "Updating channels in background…",
    home: "Home",
    browse: "Browse",
    ...
    gridLoadMore: "Load more channels",
    gridScrollHint: "Scroll down to load more automatically",
    gridEnd: "End of list",
  ...
  bn: {
    ...
    updatingFromCache: "ক্যাশ থেকে দেখানো হচ্ছে — ব্যাকগ্রাউন্ডে আপডেট হচ্ছে…",
    home: "হোম",
    browse: "ব্রাউজ",
    ...
    gridLoadMore: "আরও চ্যানেল লোড করুন",
    gridScrollHint: "আরও লোড করতে নিচে স্ক্রল করুন",
    gridEnd: "তালিকার শেষ",
