...
import { Globe, List, Menu, Radio, Search, Trophy } from "lucide-react";
import type { ViewerModule } from "@/lib/types";

export type NavItemId = "wc" | "live" | "sports" | "all" | "search" | "more";
...
export const PRIMARY_NAV: NavItem[] = [
  ...
  { id: "all",    label: "সকল",      icon: List,   action: "module", module: "all_channels"   },
